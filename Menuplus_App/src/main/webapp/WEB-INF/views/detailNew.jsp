...
<head>
	...
	<script>
		...
		function changeOrder(orderCd, orderStatusCd, e) {
	   	  	...
	   	  	changeData.waitTime = e.parents(".popup").find("#waitTime").val();
      	...
      	<section class="content">
      		<ul class="goods-li detail-li">
      			<c:forEach var="smenus" items="${orderData.smenus}">
      				...
      				<c:set var="orderAmt" value="${orderAmt + (smenus.price * smenus.cnt)}"></c:set>
	            	<li>
	               		<div class="top">
	                  		<div class="goods-nm">
...
<%--             	<a href="#" class="btn btn-green btn-l btn-wl" onclick="changeOrder('${orderData.orderCd}', 30);">주문접수</a> --%>
					<a class="btn btn-green btn-l btn-wl popup-trigger" popup-class=".popup-time-required" href="#">주문접수</a>
         	</div>
      	</section>
		<div class="popup-wrap popup-time-required">
			<div class="popup">
				<div class="popup-con">
				...
				<div class="btn-wrap">
					<a href="#" class="btn btn-l btn-wm btn-gray popup-close">취소</a> <a
						href="#" class="btn btn-l btn-wm btn-d-gray popup-close"
						onclick="changeOrder(${orderData.orderCd}, 30, $(this));">주문접수</a>
				</div>
			</div>
		</div>
