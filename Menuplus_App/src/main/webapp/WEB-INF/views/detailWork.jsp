	...
	<div class="wrap detail s-work">
		...
		<section class="content">
			...
			<div class="btn-wrap">
				...
				<a href="#" class="btn btn-blue btn-l btn-wl" onclick="changeOrder('${orderData.orderCd}', 32, 0);">완료처리</a>
			</div>
		</section>
