		...
		<section class="content">
			<div class="info-box">
				<div>
					...
					<div class="data">${storeInfo.storeNm}</div>
				</div>
				<div>
					<div class="label">사업자 번호</div>
					<div class="data">
						<a href="#" class="no-link">${storeInfo.busiNum}</a>
					</div>
				</div>
				<div>
					<div class="label">대표자명</div>
					<div class="data">${storeInfo.ceoNm}</div>
				</div>
				<div>
					<div class="label">주소</div>
					<div class="data">${storeInfo.addr}</div>
				</div>
			</div>
		</section>
